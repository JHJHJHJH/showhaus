                ...
                <div className="p-4">
                    <div className="mb-3 flex items-center justify-between">
                        ...
                        <div className="group relative">
                            ...
                            <div className="invisible absolute right-0 top-full z-20 mt-2 w-72 rounded-lg border border-slate-200 bg-white p-4 text-left opacity-0 shadow-xl transition-all duration-150 group-hover:visible group-hover:opacity-100">
